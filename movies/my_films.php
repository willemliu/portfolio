  ...
  if(mysql_num_rows($res) > 0){
    ...
    if(mysql_num_rows($menu_result) > 0 && $security_level >= mysql_result($menu_result, 0, "security_level")){
      ...
      if(mysql_num_rows($window_check) > 0){
        DBQuery("UPDATE wmc_users_windows SET opened='1', page='my_films.php' WHERE user_id=" . $user_id . " AND window='MY_FILMS'");
      } else{
        DBQuery("INSERT INTO wmc_users_windows (x, y, opened, page, window, user_id) VALUES ('80', '110', '1', 'my_films.php', 'MY_FILMS', '" . $user_id . "')");
      }
